...
impl FromWorld for ParticleRng {
    fn from_world(world: &mut World) -> Self {
        Self(GameRng::seed_from_u64(123))
    }
}
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    App::new()
        ...
        .register_rollback_component::<Ttl>()
        // xoshiro doesn't implement reflect :/ this will desync on the first rollback!!!
        // .register_rollback_resource::<ParticleRng>()
